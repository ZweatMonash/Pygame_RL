...
class Environment(gym.Env):
    ...
    def __init__(self):
        ...
        self.creep = Creep(self.windowSurface,25,(0,800),0.0,2,900,900,0.5)
        ...
        #self.observation_space =  ##will come back to this
        self.max_steps = 2000
        self.curr_step = 0
        self.done = False
    ...
    def update_blacklist(self):
        ...
        self.blacklist.extend(goals[:i])
        self.blacklist.extend(goals[(i+1):])
    ...
    def play(self):
        ...
        while training:
            ...
            # print(observation)
            print(round(self.agent.theta* 180/math.pi))
            # time.sleep (0.5)
            if done == True:
                self.reset()
